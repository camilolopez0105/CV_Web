export const cvData = {
  ...
  skills: {
    'Business Intelligence': ['Power BI (DAX, Power Query)', 'Tableau', 'Dashboard Design', 'KPI Development', 'Data Storytelling'],
    'Data Analysis & Programming': ['Python (Pandas, NumPy, Matplotlib, Seaborn)', 'SQL (Joins, CTEs, Window Functions, Aggregations)', 'Statistical Analysis'],
    'Data Management & Tools': ['ETL Pipelines', 'Data Cleaning', 'Microsoft Fabric', 'Excel (Pivot Tables, Power Query)', 'Git', 'VS Code'],
    'Core Competencies': ['Cross-functional collaboration', 'Stakeholder Communication', 'Trend Identification', 'Problem-solving'],
  },
  certifications: [],
  experience: [
    {
  ...
  languages: [
    { language: 'English', level: 'C1 Advanced', flag: '🇺🇸' },
    { language: 'Spanish', level: 'C2 Native', flag: '🇨🇴' },
  ],
  education: [
    {
      degree: 'Bootcamp in Data Analytics & AI Science',
      institution: 'Upgrade Hub, Madrid, Spain',
      year: '2026',
      description: 'Key modules: SQL for Data Analysis, Python for Data Science, Power BI & Tableau, Data Engineering with Microsoft Fabric, Machine Learning Fundamentals.',
    },
    {
      degree: 'Bachiller',
  ...
  projects: [
    {
      ...
      stack: ['Power BI', 'Power Query', 'DAX', 'Microsoft Fabric'],
    ...
    {
      name: 'SQL Case Study — Customer Segmentation for BI',
      description: 'Queried an e-commerce database using advanced SQL (CTEs, Window Functions, Joins) to build an RFM customer segmentation model. Transformed raw transaction data into actionable business insights, identifying high-value retention opportunities and Customer Lifetime Value (CLV) analysis.',
      stack: ['SQL'],
  ...
  tools: [
    ...
    { name: 'Tableau', level: 'Intermediate', category: 'visualization' },
    { name: 'Excel', level: 'Intermediate', category: 'visualization' },
    { name: 'Microsoft Fabric', level: 'Intermediate', category: 'cloud' },
